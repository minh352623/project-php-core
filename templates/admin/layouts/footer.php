...
<footer class="main-footer">
    <strong>Copyright &copy; <?php echo date('Y') ?>. Xây dựng bởi CongMinh <a href="https://adminlte.io">AdminLTE.io</a>.</strong>
    All rights reserved.
...
<script src="<?php echo _WEB_HOST_ADMIN_TEMPLATE ?>/assets/js/customer.js?ver=<?php echo rand(); ?>"></script>
<?php foot(); ?>
