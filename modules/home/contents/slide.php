<?php
if (!empty(getOptions('home_slide'))) {
                                ...
                                <div class="row">
                                    ...
                                    <div class="<?php echo $ClassCol; ?>">
                                        ...
                                        <div class="slider-text">
                                            ...
                                            <div class="button">
                                                <?php
                                                if (!empty($item['slide_button_link'])) :
                                                ?>
                                                    <a href="<?php echo $item['slide_button_link'] ?>" class="btn"><?php echo !empty($item['slide_button_text']) ? $item['slide_button_text'] : 'Xem thêm'; ?></a>
                                                <?php endif; ?>
                                                <?php
                                                if (!empty($item['slide_youtube'])) :
                                                ?>
                                                    <a href="<?php echo $item['slide_youtube'];  ?>" class="btn video video-popup mfp-fade"><i class="fa fa-play"></i>Play Now</a>
                                                <?php endif; ?>
